        ...
        element.childNodes.forEach(function (node) {
          if (node.nodeName === '#text') {
            if (!node.parentNode.dataset.fz) {
              var value = window.getComputedStyle(node.parentNode).fontSize;
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  panel.render();
  var parser = new _parser__WEBPACK_IMPORTED_MODULE_1__["default"]();
  parser.parse();
});
...
function () {
  ...
  _createClass(Parser, [{
    ...
    value: function parse() {
      ...
      var recursy = function recursy(element) {
        element.childNodes.forEach(function (node) {
          if (node.nodeName.match(/^H\d/)) _this.headers.push({
            tag: node.nodeName,
